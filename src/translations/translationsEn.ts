export const translationsEn = {
  ...
  // Notification
  sendEmail: 'We have sent you a confirmation email',
  confirmAccount: 'Your account is confirmed, you can sign in',
  updatePassword: 'Your password has been updated successfully',
  signin: 'Sign In',
